...
extern "C" EXPORT
jstring STDCALL Java_com_perez_revkiller_Features_AStyleGetVersion(JNIEnv *env, jclass);
extern "C" EXPORT
jstring STDCALL Java_com_perez_revkiller_Features_AStyleMain(JNIEnv *env,
        jobject obj,
        jstring textInJava,
        jstring optionsJava);
