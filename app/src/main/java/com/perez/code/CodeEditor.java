...
public class CodeEditor {
    ...
    private static void copyReferencedInstruction(DexFile dexFile,
            Instruction instruction, List<Instruction> instructions) {
    ...
    public static CodeItem.EncodedTypeAddrPair copyEncodedTypeAddrPair(
        DexFile dexFile, CodeItem.EncodedTypeAddrPair handler) {
    ...
    public static CodeItem.TryItem copyTryItem(DexFile dexFile,
    ...
    public static CodeItem.TryItem internTryItem(DexFile dexFile,
    ...
    public static CodeItem.EncodedTypeAddrPair internEncodedTypeAddrPair(
    ...
    public static CodeItem.EncodedCatchHandler copyEncodedCatchHandler(
        DexFile dexFile, CodeItem.EncodedCatchHandler handler) {
