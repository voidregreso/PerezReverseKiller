...
public class CodeView extends WebView {
    ...
    public void showCode(CodeEntity codeEntity) {
    ...
    public void showCode(String code) {
        CodeEntity ccode = new CodeEntity(code);
        showCode(ccode);
    }

    public void showCode(String code, CodeEntity.Language language) {
        CodeEntity ccode = new CodeEntity(code, language);
        showCode(ccode);
    }
    ...
    private void addCode(CodeEntity codeEntity) {
        document.body().appendElement("pre").appendElement("code").text(codeEntity.getCode());
    }
