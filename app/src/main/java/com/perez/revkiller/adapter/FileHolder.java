...
import com.perez.revkiller.DecompileFileUtil;
...
import com.perez.revkiller.bean.FileBean;
...
public class FileHolder extends RecyclerViewHolder<FileHolder> {
    ...
    public void onBindViewHolder(final FileHolder fileHolder, RecyclerViewAdapter adapter, int position) {
        ...
        if(fileType == FileType.directory) {
            ...
            fileHolder.fileChildCount.setText(fileBean.getChildCount() + " items");
            ...
            fileHolder.fileSize.setText(DecompileFileUtil.sizeToChange(fileBean.getSize()));
