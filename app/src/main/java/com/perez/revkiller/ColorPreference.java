...
public class ColorPreference extends DialogPreference {
    ...
    public ColorPreference(Context context, AttributeSet attrs) {
        ...
        if(attribute.equals("fontcolor"))
            ...
            color = 0xFFCCCCCC;
        color = sharedPref.getInt(attribute, color);
    }
    ...
    protected void onPrepareDialogBuilder(AlertDialog.Builder builder) {
        ...
        final ImageView colormap = (ImageView) colorView
                                   .findViewById(R.id.colormap);
        ...
        colormap.setOnTouchListener(new OnTouchListener() {
            public boolean onTouch(View v, MotionEvent event) {
                ...
                int x = (int)((event.getX() - 15) * bitmap.getWidth() / (colormap
                              .getWidth() - 30));
                int y = (int)((event.getY() - 15) * bitmap.getHeight() / (colormap
                              .getHeight() - 30));
