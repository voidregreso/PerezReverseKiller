...
public class SettingsActivity extends AppCompatPreferenceActivity implements Preference.OnPreferenceChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findPreference("install_cert").setOnPreferenceClickListener(preference -> {
            changeSystemProxy();
            return false;
        });

        findPreference("system_proxy").setOnPreferenceClickListener(preference -> {
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        if (preference.getKey().equals("enable_filter")) {
            Toast.makeText(this, R.string.restart_effect_tips, Toast.LENGTH_SHORT).show();
        }
        return true;
    }
    ...
    public void installCert() {
        ...
        Toast.makeText(this, R.string.obligatory_cert_inst, Toast.LENGTH_LONG).show();
    ...
    public String getHost() {
        ...
        for (String key : advancedHostResolver.getHostRemappings().keySet()) {
            result.append(key).append(" ").append(advancedHostResolver.getHostRemappings().get(key)).append("\n");
        }
