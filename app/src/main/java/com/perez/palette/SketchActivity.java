...
public class SketchActivity extends AppCompatActivity implements View.OnClickListener, PaletteView.Callback,Handler.Callback {
    ...
    private void initSaveProgressDlg(){
        ...
        mSaveProgressDlg.setMessage(getString(R.string.palette_saving));
    ...
    public boolean handleMessage(Message msg) {
        switch (msg.what){
            case MSG_SAVE_FAILED:
                ...
                Toast.makeText(this,R.string.palette_fs,Toast.LENGTH_SHORT).show();
                break;
            case MSG_SAVE_SUCCESS:
                mSaveProgressDlg.dismiss();
                Toast.makeText(this,getString(R.string.palette_sto) + savedpath,Toast.LENGTH_SHORT).show();
                break;
        }
        return true;
    }
            ...
            case R.id.save:
                ...
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        String savedFile = saveImage(bm, 95);
                        if (savedFile != null) {
                            scanFile(SketchActivity.this, savedFile);
                            mHandler.obtainMessage(MSG_SAVE_SUCCESS).sendToTarget();
                        } else mHandler.obtainMessage(MSG_SAVE_FAILED).sendToTarget();
                    }
                }).start();
                break;
        }
