...
public class SignerParams {
    ...
    public SignerParams(Context context) {
    ...
    private void loadPrivateKeyAndCertsFromFiles(PasswordRetriever passwordRetriever)
        ...
        byte[] privateKeyBlob = readFully(mContext, keyFile);
        ...
        try (InputStream in = assetManager.open(certFile)) {
    ...
    private static byte[] readFully(Context context, String assetsPath) throws IOException {
        AssetManager assetManager = context.getAssets();
        ByteArrayOutputStream result = new ByteArrayOutputStream();
        InputStream inputStream = assetManager.open(assetsPath);
        drain(inputStream, result);
