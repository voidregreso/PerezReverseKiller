...
public class ApkSignerTool {
    ...
    public static void sign(Context context, File inf, String outf) {
        try {
            sign(context, ("--v1-signing-enabled --v2-signing-enabled --v3-signing-enabled" +
                    " --key keys/testkey.pk8 --cert keys/testkey.x509.pem --in " + inf.toString()
                + " --out " + outf).split(" "));
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    private static void sign(Context context, String[] params) throws Exception {
        ...
        SignerParams signerParams = new SignerParams(context);
        SigningCertificateLineage lineage = null;
        SignerParams sourceStampSignerParams = new SignerParams(context);
        ...
        while ((optionName = optionsParser.nextOption()) != null) {
            ...
            if ("out".equals(optionName)) {
                ...
                if (!signerParams.isEmpty()) {
                    ...
                    signerParams = new SignerParams(context);
                }
                ...
                sourceStampSignerParams = processSignerParams(context, optionsParser);
    ...
    private static void rotate(Context context, String[] params) throws Exception {
        ...
        while ((optionName = optionsParser.nextOption()) != null) {
            ...
            if ("out".equals(optionName)) {
                ...
                oldSignerParams = processSignerParams(context, optionsParser);
            } else if ("new-signer".equals(optionName)) {
                newSignerParams = processSignerParams(context, optionsParser);
            } else if ("min-sdk-version".equals(optionName)) {
                minSdkVersion = optionsParser.getRequiredIntValue("Mininimum API Level");
            } else if (("v".equals(optionName)) || ("verbose".equals(optionName))) {
                verbose = optionsParser.getOptionalBooleanValue(true);
    ...
    public static void lineage(Context context, String[] params) throws Exception {
        boolean verbose = false;
        boolean printCerts = false;
        ...
        while ((optionName = optionsParser.nextOption()) != null) {
            if ("in".equals(optionName)) {
                ...
                SignerParams signerParams = processSignerParams(context, optionsParser);
                signers.add(signerParams);
            } else if (("v".equals(optionName)) || ("verbose".equals(optionName))) {
                verbose = optionsParser.getOptionalBooleanValue(true);
            } else if ("print-certs".equals(optionName)) {
    ...
    private static SignerParams processSignerParams(Context context, OptionsParser optionsParser)
