...
import es.perez.netdiagnosis.Adapter.PageFilterAdapter;
import es.perez.netdiagnosis.Bean.PageBean;
import es.perez.netdiagnosis.Fragment.BaseFragment;
import es.perez.netdiagnosis.Fragment.BackHandledInterface;
import es.perez.netdiagnosis.Fragment.NetworkFragment;
import es.perez.netdiagnosis.Fragment.PreviewFragment;
import es.perez.netdiagnosis.Fragment.WebViewFragment;
...
import es.perez.netdiagnosis.Utils.ZipUtils;
...
public class NDGAct extends AppCompatActivity implements BackHandledInterface {
    ...
    public void createPage() {
        ...
        ((CrashApp) getApplication()).proxy.newPage(time);

        Snackbar.make(binding.flContain, "HAR file has created a new page:" + time, Snackbar.LENGTH_LONG)
